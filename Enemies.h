...
public:
    ...
    EnemyListIt DestroyEnemy(EnemyListIt iter);	//Niszczenie przeciwnika
    ...
    EnemyList EnemiesList() { return m_Enemies; }                           //zwrócenie listy przeciwników
...
private:
    ...
    EnemyList m_Enemies;           //Lista przeciwnikow
